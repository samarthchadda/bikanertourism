...
<form name="amount" method="post">
		<div class="selectroom_top">
			...
			<div class="bnr-right">
				...
				value="<?php if(isset($_POST['todate'])){ echo $_POST['todate']; }?>">
			</div><br><br><br><br><br>
			...
			<!-- <div class="form-group">
 	 		...
 	 		<input type="text" class="form-control" id="usr">
				...
				<table>
		<tr>
			<td><b>Your Location:</b></td>
			
		</tr>
		<tr>
			<td><input type="text" name="loc" required="" value="<?php if(isset($_POST['loc'])){ echo $_POST['loc']; }?>">
			</td>
			
				
		</tr>
</table>
					<input class="btn btn-block btn-primary" type="submit" name="search" value="search" required="">
			</div>
				...
				<div class="grand">
					...
					if ($loc=="jaipur") {
						...
						$todat=$_POST['todate'];
						$fromdat=$_POST['fromdate'];
						$date1=date_create("$todat");
						$date2=date_create("$fromdat");
						$diff=date_diff($date2,$date1);
						echo $diff->format("%R%a days");
						if(($diff->format("%R%a days"))==2){ 
							$res= "Rs.1200";
						}
						if(($diff->format("%R%a days"))==4){ 
							$res= "Rs.2000";
						}
						...
						if(($diff->format("%R%a days"))>7){ 
							$res= "Sorry Package Cannot be more than 7 days";
						}
						}
		...
		<div class="selectroom_top">
			...
			<div class="selectroom-info animated wow fadeInUp animated" data-wow-duration="1200ms" data-wow-delay="500ms" style="visibility: visible; animation-duration: 1200ms; animation-delay: 500ms; animation-name: fadeInUp; margin-top: -70px">
				<ul>
					...
					<button type="submit" name="submit2" class="btn-primary btn btn-block btn-lg">Book My Ticket</button>
						</li>
						<?php } else {?>
