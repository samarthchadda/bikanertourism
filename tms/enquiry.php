...
<div class="privacy">
	<div class="container">
		<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown; text-align: center; color: red;">Enquiry Form Password</h3>
		<form name="enquiry" method="post" style="margin-left: 33%;">
